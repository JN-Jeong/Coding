...
def solution(rectangle, characterX, characterY, itemX, itemY):
    ...
    characterX, characterY = len(board) - characterY * 2 - 1, characterX * 2
    itemX, itemY = len(board) - itemY * 2 - 1, itemX * 2
...
def make_board(rectangle: list):
    ...
    for x1, y1, x2, y2 in rectangle:
        x1, y1 = len(board) - y1 * 2 - 1, x1 * 2
        x2, y2 = len(board) - y2 * 2 - 1, x2 * 2
